                            ...
                            <form class="pt-3" method="POST" action=" {{route('account.processRegister')}} ">
                                ...
                                <div class="form-group">
                                    <input type="text" name="phone" class="form-control form-control-lg"
                                        value="{{old('phone')}}" id="exampleInputPassword1" placeholder="Số điện thoại">
                                    @error('phone')
                                    <p class="text-danger"> {{$message}} </p>
                                    @enderror
                                </div>
                                ...
                                <div class="text-center mt-4 font-weight-light"> Bạn đã có tài khoản?
                                    <a href="{{ route('account.login') }}" class="text-primary">Đăng nhập?</a>
                                </div>
                            </form>
                        </div>
                    </div>
