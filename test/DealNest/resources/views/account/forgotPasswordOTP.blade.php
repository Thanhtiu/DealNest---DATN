        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h4>Quên mật khẩu</h4>
              <form class="pt-3" method="POST" action=" {{route('account.password.verifyOTP')}} ">
                @csrf
                <div class="form-group">
                  <p>Mã xác thực đã được gửi đến Email của bạn. Vui lòng vào hộp thư để kiểm tra!</p>

                </div>

                <div class="form-group">
                  <input style="margin-bottom:10px" type="text" name="otp" class="form-control form-control-lg"
                    id="exampleInputPassword1" placeholder="OTP">
                  @error('otp')
                ...
                <div class="text-center mt-4 font-weight-light"> Bạn chưa nhận được mã?
                  <a href="{{ route('account.register') }}" class="text-primary">Gửi lại?</a>
                </div>
              </form>
            </div>
          </div>
