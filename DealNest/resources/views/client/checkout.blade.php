    ...
    <div class="container">
        ...
        <div class="additional-section">
            ...
            <div class="payment-method">
                ...
                <div class="payment-details" style="display: flex; justify-content: space-between; align-items: center; text-align: right;">
                ...
                <div id="payment-options" style="display: none; margin-top: 10px;">
                    ...
                    <div class="payment-method-button" data-method="CreditCard" style="cursor: pointer;">Thẻ Tín dụng/Ghi nợ</div>
                    <div class="payment-method-button" data-method="COD" style="cursor: pointer;">Thanh toán khi nhận hàng</div>
                </div>
            </div>
