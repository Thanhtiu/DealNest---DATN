      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ route('seller.product.update', ['id' => $product->id]) }}" method="POST"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="slug" class="form-control" id="slug" placeholder="Slug sản phẩm" value="{{$product->slug}}">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <input type="hidden" id="currentSubCategoryId" value="{{ $product->category->id }}">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="price" id="price" placeholder="Giá" value="{{$product->price}}">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="mrp" id="mrp" placeholder="Giá bán lẻ" value="{{$product->mrp}}">
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-6">
                    ...
                    <select class="form-select form-select-lg" id="country" name="country_id">
