...
<style>
    ...
    .banner-section {
        ...
        width: 100%;
        max-width: 1200px;
        margin: 30px auto 20px; /* Thêm margin-top để đẩy xuống */
        overflow: hidden;
    }
    ...
    .slider-container {
        padding: 20px; /* Khoảng cách xung quanh slider */
        background-color: #f8f9fa; /* Màu nền cho khu vực slider */
        border-radius: 15px; /* Bo góc cho slider */
        box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Đổ bóng cho slider */
    }

    .banner-slider {
        display: flex;
        gap: 20px; /* Khoảng cách giữa các banner */
        transition: transform 0.5s ease-in-out;
    }

    .banner-item {
        min-width: calc(50% - 10px); /* Đảm bảo banner chiếm 50% chiều rộng và trừ đi khoảng cách */
    ...
    .banner-item img {
        width: 590px;
        height: 311px;
        object-fit: cover; /* Đảm bảo hình ảnh lấp đầy không gian, có thể cắt bớt */
        display: block;
        border-radius: 15px;
    }
    ...
    .slider-icon {
        ...
        color: #6c757d; /* Màu sắc mặc định cho các biểu tượng */
    }

    .slider-icon:hover {
        color: #f05440; /* Màu khi hover */
    }

    .slider-icon.active {
        color: #0d6efd; /* Màu cho biểu tượng đang hoạt động */
    }
</style>
            ...
            <div class="category-list">
                @foreach($categories as $item)
                    <div class="category-item">
                        <img src="https://down-vn.img.susercontent.com/file/ce8f8abc726cafff671d0e5311caa684@resize_w320_nl.webp" alt="{{ $item->name }}">
                        <span>{{ $item->name }}</span>
                    </div>
                @endforeach
            </div>
